$("#queryCategoryLevel1").change(function(){
	...
	if(queryCategoryLevel1 != '' && queryCategoryLevel1 != null){
		$.ajax({
			type:"GET",//请求类型
			url:"/AppInfo/manager/backend/app/categorylevellist.json",//请求的url 
...
$(".checkApp").on("click",function(){
	...
	if(status == "1" && vid != "" && vid != null){//待审核状态下才可以进行审核操作
		window.location.href="/AppInfo/manager/backend/app/appcheck?aid="+ obj.attr("appinfoid") + "&vid="+ obj.attr("versionid");
