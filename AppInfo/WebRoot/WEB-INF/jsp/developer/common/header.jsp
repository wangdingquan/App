							...
							<ul class="nav side-menu">
								<li><a><i class="fa fa-home"></i> APP账户管理 <span
									...
									<ul class="nav child_menu">
										<li><a href="${pageContext.request.contextPath }/dev/flatform/app/apply">APP开发者账户申请</a>
										</li>
										<li><a href="${pageContext.request.contextPath }/dev/flatform/app/piminfo?id=${devInfo.id}">个人账户信息维护</a>
										</li>
									</ul></li>
